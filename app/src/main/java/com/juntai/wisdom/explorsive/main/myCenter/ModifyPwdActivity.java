 ...
 * @date 2020/3/10 9:33
 */
public class ModifyPwdActivity extends BaseAppActivity<MainPresent> implements MainContactInterface,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.commit_request_tv:
                ...
                //修改密码
                mPresenter.modifyPwd(getBaseBuilder().add("oldPassword", MD5.md5(String.format("%s#%s", UserInfoManager.getMobile(),
                        getTextViewValue(mSetPwdOlderEt))))
                        .add("newPassword", MD5.md5(String.format("%s#%s", UserInfoManager.getMobile(),
